...
//   let start = Math.max(0, Math.min(active - half, count - MAX));
...
//       style={{ background: "transparent", fontFamily: "'Syne', sans-serif" }}>
//       <StyleInjector />
...
//           <div className="flex items-baseline gap-1.5 px-4 py-2 rounded-full"
//             style={{
...
//             style={{
//               position: "absolute",
//               left: "max(8px, calc(50% - 320px))",
//               zIndex: 30,
//               padding: isMobile ? "8px" : "11px",
//               borderRadius: "50%",
//               border: "1px solid",
//               borderColor: active === 0 ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.12)",
//               background: active === 0 ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.07)",
//               color: active === 0 ? "rgba(255,255,255,0.15)" : "white",
//               cursor: active === 0 ? "not-allowed" : "pointer",
//               display: "flex", transition: "all 0.2s",
//             }}
//           >
//             <ChevronLeft style={{ width: isMobile ? 18 : 22, height: isMobile ? 18 : 22 }} />
//           </button>
...
//             style={{
//               position: "absolute",
//               right: "max(8px, calc(50% - 320px))",
//               zIndex: 30,
//               padding: isMobile ? "8px" : "11px",
//               borderRadius: "50%",
//               border: "1px solid",
//               borderColor: active === shorts.length - 1 ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.12)",
//               background: active === shorts.length - 1 ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.07)",
//               color: active === shorts.length - 1 ? "rgba(255,255,255,0.15)" : "white",
//               cursor: active === shorts.length - 1 ? "not-allowed" : "pointer",
//               display: "flex", transition: "all 0.2s",
//             }}
//           >
//             <ChevronRight style={{ width: isMobile ? 18 : 22, height: isMobile ? 18 : 22 }} />
//           </button>
//         </div>
